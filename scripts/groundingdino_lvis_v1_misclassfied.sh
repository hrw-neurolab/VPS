...
eval_list="datasets/lvis_v1_rare_groundingdino_misclassification.json"
lambda1=1
lambda2=1
division_number=100
save_dir="./submodular_results/grounding-dino-lvis-v1-misclassification/"
...
do
    ...
    CUDA_VISIBLE_DEVICES=$device python -m detection_attribution.groundingdino_lvis_v1_misclassification_detection \
    --Datasets $dataset \
    --eval-list $eval_list \
    --lambda1 $lambda1 \
    --lambda2 $lambda2 \
