...
eval_list="datasets/coco_groundingdino_misclassification.json"
lambda1=1
lambda2=1
division_number=100
save_dir="./submodular_results/grounding-dino-coco-misclassification/"
...
do
    ...
    CUDA_VISIBLE_DEVICES=$device python -m detection_attribution.groundingdino_misclassification_detection \
    --Datasets $dataset \
    --eval-list $eval_list \
    --lambda1 $lambda1 \
    --lambda2 $lambda2 \
