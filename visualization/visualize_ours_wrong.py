...
def parse_args():
    ...
    parser.add_argument('--explanation-dir', 
                        type=str, 
                        default='submodular_results/grounding-dino-refcoco-mistake/slico-1.0-1.0-division-number-64',
                        help='Save path for saliency maps generated by our methods.')
    parser.add_argument('--Datasets',
                        type=str,
                        default='datasets/refcoco/image',
                        help='Datasets.')
...
def main(args):
    ...
    for json_file_name in tqdm(json_file_names):
        ...
        vis_saliency_map = annotate_with_grounding_dino(vis_saliency_map, np.array([predicted_box]), ["incorrectly grounded"], color=(238,59,59))
        vis_saliency_map_w_box = annotate_with_grounding_dino(vis_saliency_map, np.array([target_box]), [target_category])
        
        
        visualization(image, S_set, saved_json_file, vis_saliency_map_w_box, target_category, index=18)
